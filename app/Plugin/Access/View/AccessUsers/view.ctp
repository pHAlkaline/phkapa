<h2 id="page-heading"><?php echo __('View %s', __n('User','Users',1)); ?></h2>
    ...
    <div class="grid_4" id="actions">
            ...
            <div class="block" id="admin-actions">
                ...
                <ul class="menu">
                    ...
                    <li><?php echo $this->Html->link(__('Edit %s', __n('User','Users',1)), array('action' => 'edit', $user['User']['id'])); ?> </li>
                    <li>
                        <?php echo $this->Html->link(__('Delete %s', __n('User','Users',1)), array('action' => 'delete', $user['User']['id']),array('confirm'=>__('Are you sure you want to delete # %s?', $user['User']['name']))); ?>
