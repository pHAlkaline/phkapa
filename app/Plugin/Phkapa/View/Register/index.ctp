            ...
            foreach ($tickets as $ticket):
                ...
                <tr<?php echo $class; ?>>
                    ...
                    <td class="actions">
                        ...
                        <?php echo $this->Html->link(__d('phkapa', 'Review'), array('action' => 'send', $ticket['Ticket']['id']), array('escape' => false, 'confirm' => __d('phkapa', 'Are you sure you want to send # %s?', $ticket['Ticket']['id']))); ?>
