        ...
        foreach ($actions as $action):
            ...
            <tr<?php echo $class; ?>>
                ...
                if ($action['Action']['close_date'] != '')
                    ...
                    ?>&nbsp;</td>
                <td><?php echo h($action['ActionEffectiveness']['name']); ?>&nbsp;</td>
                ...
                <td class="actions">
                    ...
                    <?php echo ' | ' . $this->Html->link(__d('phkapa','Delete'), array('action' => 'delete', $action['Action']['id']), array('confirm'=> __d('phkapa','Are you sure you want to delete # %s?', $action['Action']['id']))); ?>
                </td>
            </tr>
        <?php endforeach; ?>
