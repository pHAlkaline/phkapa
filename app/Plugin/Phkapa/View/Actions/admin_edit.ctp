<?php $this->html->script('/phkapa/js/action_edit_add', false); ?>
<h2 class="grid_16" id="page-heading"><?php echo __d('phkapa','Edit %s', __d('phkapa','Action')); ?></h2>
<div class="grid_16 actionsContainer">
    <div class="grid_4" id="actions">	
            ...
            <div class="block" id="admin-actions">			
                ...
                <ul class="menu">
                    <li><?php echo $this->Html->link(__d('phkapa','Delete'), array('action' => 'delete', $this->Form->value('Action.id')), array('confirm'=> __d('phkapa','Are you sure you want to delete # %s?', $this->Form->value('Action.id')))); ?></li>
    ...
    <div class="actions form">
        ...
        <fieldset class="ui-corner-all ui-widget-content" >
            ...
            echo $this->Form->input('ticket_id',array('label' => __d('phkapa','Ticket')));
