<h2 id="page-heading"><?php echo __dn('phkapa', 'Safety', 'Safeties', 2); ?></h2>
    ...
    if (!empty($safeties)) {
        ...
        <table cellpadding="0" cellspacing="0">
            ...
            foreach ($safeties as $type):
                ...
                ?>
                <tr<?php echo $class; ?>>
                    <td><?php echo $type['Safety']['id']; ?>&nbsp;</td>
                    <td><?php echo h($type['Safety']['order']); ?>&nbsp;</td>
                    <td><?php echo h($type['Safety']['name']); ?>&nbsp;</td>
                    <td><?php echo $this->Utils->yesOrNo($type['Safety']['active']); ?>&nbsp;</td>
                    <td class="nowrap"><?php echo $this->Time->format(Configure::read('dateFormatSimple'), $type['Safety']['created']); ?>&nbsp;</td>
                    <td class="nowrap"><?php echo $this->Time->format(Configure::read('dateFormatSimple'), $type['Safety']['modified']); ?>&nbsp;</td>
                    <td class="actions">
                        <?php echo $this->Html->link(__d('phkapa', 'View'), array('action' => 'view', $type['Safety']['id'])); ?>
                        <?php echo ' | ' . $this->Html->link(__d('phkapa', 'Edit'), array('action' => 'edit', $type['Safety']['id'])); ?>
                        <?php echo ' | ' . $this->Html->link(__d('phkapa', 'Delete'), array('action' => 'delete', $type['Safety']['id']), array('confirm'=> __d('phkapa','Are you sure you want to delete # %s?', $type['Safety']['name']))); ?>
                    </td>
                </tr>
            <?php endforeach; ?>
