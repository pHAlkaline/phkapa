            ...
            foreach ($priorities as $type):
                ...
                <tr<?php echo $class; ?>>
                    ...
                    <td class="actions">
                        ...
                        <?php echo ' | ' . $this->Html->link(__d('phkapa', 'Delete'), array('action' => 'delete', $type['Priority']['id']), array('confirm'=> __d('phkapa','Are you sure you want to delete # %s?', $type['Priority']['name']))); ?>
                    </td>
                </tr>
            <?php endforeach; ?>
