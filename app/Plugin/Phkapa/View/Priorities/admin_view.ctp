<h2 id="page-heading"><?php echo __d('phkapa','View %s', __d('phkapa','Priority')); ?></h2>
    ...
    <div class="grid_4" id="actions">
        ...
        <div class="block" id="admin-actions">
            ...
            <ul class="menu">				
                ...
                <li><?php echo $this->Html->link(__d('phkapa','Delete %s', __d('phkapa','Priority')), array('action' => 'delete', $priority['Priority']['id']), array('confirm'=> __d('phkapa','Are you sure you want to delete # %s?', $priority['Priority']['name']))); ?> </li>
...
?>>
                    ...
                    <dd<?php if ($i++ % 2 == 0)
                            echo $class;
                        ?>>
                            <?php echo $this->Utils->yesOrNo($priority['Priority']['active']); ?>
                        &nbsp;
                    </dd>
                    <dt<?php if ($i % 2 == 0)
                                echo $class;
                    ...
                    <dd<?php if ($i++ % 2 == 0)
                            echo $class;
                            ?>>
<?php echo $this->Time->format(Configure::read('dateFormat'), $priority['Priority']['created']); ?>
                        &nbsp;
                    </dd>
                    <dt<?php if ($i % 2 == 0)
    echo $class;
?>><?php echo __d('phkapa','Modified'); ?></dt>
    ...
    echo $class;
?>>
<?php echo $this->Time->format(Configure::read('dateFormat'), $priority['Priority']['modified']); ?>
                        &nbsp;
                    </dd>
                </dl>
            </div>
