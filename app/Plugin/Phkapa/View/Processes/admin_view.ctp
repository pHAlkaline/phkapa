...
<div class="grid_16 actionsContainer">
    ...
    <div id="tabs">
        <ul>
            ...
            <li><a href="#tabs-activities"><?php echo __dn('phkapa', 'Activity', 'Activities', 2) . ' (' . count($process['Activity']) . ')'; ?></a></li>

            <li><a href="#tabs-categories"><?php echo __dn('phkapa', 'Category', 'Categories', 2) . ' (' . count($process['Category']) . ')'; ?></a></li>
            <li><a href="#tabs-users"><?php echo __dn('phkapa', 'User', 'Users', 2) . ' (' . count($process['User']) . ')'; ?></a></li>
