    ...
    <div class="grid_4" id="actions">
        ...
        <div class="block" id="admin-actions">
            ...
            <ul class="menu">				
                ...
                <li><?php echo $this->Html->link(__d('phkapa','Delete %s', __d('phkapa','Action Type')), array('action' => 'delete', $action_type['ActionType']['id']), array('confirm'=> __d('phkapa','Are you sure you want to delete # %s?', $action_type['ActionType']['name']))); ?> </li>
