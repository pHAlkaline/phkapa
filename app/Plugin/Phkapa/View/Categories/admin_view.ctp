...
<div class="grid_16 actionsContainer">
    ...
    <div id="tabs">
        <ul>
            ...
            <li><a href="#tabs-processes"><?php echo __dn('phkapa', 'Process', 'Processes', 2) . ' (' . count($category['Process']) . ')'; ?></a></li>
            <li><a href="#tabs-causes"><?php echo __dn('phkapa', 'Cause', 'Causes', 2) . ' (' . count($category['Cause']) . ')'; ?></a></li>
