<h2 id="page-heading"><?php echo __dn('phkapa','Customer','Customers',2); ?></h2>
    ...
    <table cellpadding="0" cellspacing="0">
        ...
        foreach ($customers as $customer):
            ...
            <tr<?php echo $class; ?>>
                ...
                <td class="actions">
                    <?php echo $this->Html->link(__d('phkapa','View'), array('action' => 'view', $customer['Customer']['id'])); ?>
                    <?php echo ' | ' . $this->Html->link(__d('phkapa','Edit'), array('action' => 'edit', $customer['Customer']['id'])); ?>
                    <?php echo ' | ' . $this->Html->link(__d('phkapa','Delete'), array('action' => 'delete', $customer['Customer']['id']), array('confirm'=> __d('phkapa','Are you sure you want to delete # %s?', $customer['Customer']['name']))); ?>
                </td>
            </tr>
        <?php endforeach; ?>
