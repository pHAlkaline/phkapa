            ...
            foreach ($tickets as $ticket):
                ...
                <tr<?php echo $class; ?>>
                    ...
                    <td class="actions">
                        ...
                        <?php echo $this->Html->link(__d('phkapa','Send'), array('action' => 'send', $ticket['Ticket']['id']), null, __d('phkapa','Are you sure you want to send # %s?', $ticket['Ticket']['id'])); ?>
                        ...
                        <?php echo ' | ' . $this->Html->link(__d('phkapa','Delete'), array('action' => 'delete', $ticket['Ticket']['id']), null, __d('phkapa','Are you sure you want to delete # %s?', $ticket['Ticket']['id'])); ?>
