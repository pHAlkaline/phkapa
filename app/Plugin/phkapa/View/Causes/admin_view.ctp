    ...
    <div class="grid_4" id="actions">
        ...
        <div class="block" id="admin-actions">
            ...
            <ul class="menu">				
                ...
                <li><?php echo $this->Html->link(__d('phkapa','Delete %s', __d('phkapa','Cause')), array('action' => 'delete', $cause['Cause']['id']), array('confirm'=> __d('phkapa','Are you sure you want to delete # %s?', $cause['Cause']['id']))); ?> </li>
...
?>>
    ...
    <div class="ui-corner-all ui-widget" id="related">
        <h2>
            <a href="#" id="toggle-related-records"><?php echo __d('phkapa','Related') . ' - ' . __dn('phkapa','Category','Categories',2) . ' (' . count($cause['Category']) . ')'; ?></a>
        </h2>
