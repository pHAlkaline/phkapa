    ...
    <div class="grid_4" id="actions">
        ...
        <div class="block" id="admin-actions">
            ...
            <ul class="menu">				
                ...
                <li><?php echo $this->Html->link(__d('phkapa','Delete %s', __d('phkapa','Cause')), array('action' => 'delete', $cause['Cause']['id']), null, __d('phkapa','Are you sure you want to delete # %s?', $cause['Cause']['id'])); ?> </li>
