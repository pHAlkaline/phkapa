...
<table cellpadding="0" cellspacing="0">
    ...
    foreach ($tickets as $ticket):
        ...
        <tr<?php echo $class; ?>>
            ...
            <td>
                <?php echo iconv("UTF-8", "ISO-8859-1//TRANSLIT", $ticket['Registar']['name']); ?>
            </td>
...
<table><tr><td> </td></tr><tr><td><?php echo iconv("UTF-8", "ISO-8859-1//TRANSLIT",__d('phkapa','List %s', __dn('phkapa','Action','Actions',2))); ?></td></tr></table>
<table>
    <?php
    $tableHeaders = $this->html->tableHeaders(
            array(iconv("UTF-8", "ISO-8859-1//TRANSLIT", __d('phkapa', 'Id')),
