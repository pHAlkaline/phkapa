...
<div class="grid_16 actionsContainer">
    <div class="grid_4" id="actions">	
        ...
        <div class="block" id="admin-actions">			
            ...
            <ul class="menu">
                <li><?php echo $this->Html->link(__d('phkapa','Delete'), array('action' => 'delete', $this->Form->value('Process.id')), null, __d('phkapa','Are you sure you want to delete # %s?', $this->Form->value('Process.id'))); ?></li>
