            ...
            foreach ($activities as $activity):
                ...
                <tr<?php echo $class; ?>>
                    ...
                    <td class="actions">
                        ...
                        <?php echo ' | ' . $this->Html->link(__d('phkapa', 'Delete'), array('action' => 'delete', $activity['Activity']['id']), null, __d('phkapa', 'Are you sure you want to delete # %s?', $activity['Activity']['name'])); ?>
                    </td>
                </tr>
            <?php endforeach; ?>
