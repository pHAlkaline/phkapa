    ...
    <div class="grid_4" id="actions">
        ...
        <div class="block" id="admin-actions">
            ...
            <ul class="menu">				
                ...
                <li><?php echo $this->Html->link(__d('phkapa','Delete %s', __d('phkapa','Origin')), array('action' => 'delete', $origin['Origin']['id']), null, __d('phkapa','Are you sure you want to delete # %s?', $origin['Origin']['id'])); ?> </li>
