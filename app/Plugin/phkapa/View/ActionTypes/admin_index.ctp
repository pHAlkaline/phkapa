...
<div class="grid_16 actionsContainer">
    ...
    <?php echo ' | ' . $this->Html->link(__d('phkapa', 'Delete'), array('action' => 'delete', $action_type['ActionType']['id']), null, __d('phkapa', 'Are you sure you want to delete # %s?', $action_type['ActionType']['name'])); ?>
            </td>
        </tr>
    <?php endforeach; ?>
