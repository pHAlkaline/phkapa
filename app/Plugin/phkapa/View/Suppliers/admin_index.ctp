<h2 id="page-heading"><?php echo __dn('phkapa','Supplier','Suppliers',2); ?></h2>
        ...
        foreach ($suppliers as $supplier):
            ...
            <tr<?php echo $class; ?>>
                ...
                <td class="actions">
                    ...
                    <?php echo ' | ' . $this->Html->link(__d('phkapa','Delete'), array('action' => 'delete', $supplier['Supplier']['id']), null, __d('phkapa','Are you sure you want to delete # %s?', $supplier['Supplier']['id'])); ?>
                </td>
            </tr>
        <?php endforeach; ?>
