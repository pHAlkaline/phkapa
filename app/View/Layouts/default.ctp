        ...
        <div id="header_separator">
            ...
            if (AuthComponent::user('id')) {
                ...
                <div style="width:99%; text-align: right;color: #FFFFFF; padding-top: 5px;">
                    <?php echo __('User') . ': '; ?><?php echo $this->Session->read('Auth.User.name') ?> ...<?php echo $this->Html->link(__('End Session'), '/users/logout', array('style' => 'color:#fff;', 'class' => 'menuitem', 'target' => '_self')); ?></div>
                <?php
            }
            ?>
        </div>
