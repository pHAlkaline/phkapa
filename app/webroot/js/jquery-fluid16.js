var fluid = {
    ...
    Toggle : function(){
        ...
        $.each(
            ["admin-left-menu", "admin-actions", "help", "filter", "related-records", "grid", "paragraphs", "blockquote", "list-items", "section-menu", "tables", "forms", "login-forms", "search", "articles", "accordion", "fase1","fase2","fase3","fase4"],
            function() {
    ...
    AutoHide:function(){
        /*$("#actions").mouseleave(function(e) {
            $('#toggle-admin-actions').removeClass('visible').addClass('hidden');
            $('#admin-actions').slideUp();
            e.preventDefault();
        });*/
